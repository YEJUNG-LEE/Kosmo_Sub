	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="active"><a href="<%=noForm%>">Home</a></li>
				<li>
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li>
							<c:if test="${whologin == 0}">
								<a href="<%=noForm%>">회원 가입</a>
							</c:if>
							<c:if test="${whologin != 0}">
								<a href="<%=noForm%>">회원 정보 수정</a>
							</c:if>
						</li>
						<li>
							<c:if test="${whologin == 0}">
						...
						<li>
							<c:if test="${whologin == 1}">
								<a href="<%=noForm%>">회원 탈퇴</a>
							</c:if>
						</li>
						<li>
							<c:if test="${whologin == 2}">
								<a href="<%=noForm%>">회원 목록 보기</a>
							</c:if>
						</li>
						<li>
							<c:if test="${whologin == 1}">
								<a href="<%=noForm%>">회원 상세 보기</a>
							</c:if>
						</li>
					</ul>
				</li>
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li>
							<c:if test="${whologin != 0}">
								<a href="<%=noForm%>">게시물 등록</a>
							</c:if>
						</li>	 
						<li>
							<c:if test="${whologin != 0}">
								<a href="<%=noForm%>">게시물 목록 보기</a>
							</c:if>
						</li>						
					</ul>
				</li>				
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li>
							<c:if test="${whologin == 2}">
								<a href="<%=noForm%>">상품 등록</a>
							</c:if>
						</li>	 
						<li>
							<a href="<%=noForm%>">상품 목록 보기</a>
						</li>						
					</ul>
				</li>
				<!-- 쇼핑몰 섹션 -->
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li>
							<c:if test="${whologin != 0}">
								<a href="<%=noForm%>">나의 쇼핑 내역</a>
							</c:if>
						</li>	 
						<li>
							<c:if test="${whologin != 0}">
								<a href="<%=noForm%>">장바구니</a>
							</c:if>
						</li>						
					</ul>
				</li>
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="<%=noForm%>">회원과 게시물</a></li>	 
						<li><a href="<%=noForm%>">회원별 게시물 건수</a></li>
						<li><a href="<%=noForm%>">주문 정보</a></li>
						<li><a href="<%=noForm%>">고객별 매출 총액</a></li>
						<li><a href="<%=noForm%>">회원별 주문 건수</a></li>						    
					</ul>
				</li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<c:if test="${whologin == 0}">
	      			<li>
	      				<a href="<%=noForm%>"><span class="glyphicon glyphicon-user"></span> 회원 가입</a>
	      			</li>
	      			<li>
				...
				<c:if test="${whologin != 0}">
	      			<li>
	      				<a href="<%=noForm%>"><span class="glyphicon glyphicon-pencil"></span> 회원 정보 수정</a>
	      			</li>
	      			<li>
