        	...
        	<div class="app__desktop-scroll">
            	<div>
                	...
                	<div data-v-3b623747="">
						...
						<div data-v-3b623747="">
	    					<div data-v-3b623747="" class="login__title">고객 로그인
	    					</div>
						    ...
						    <article data-v-3b623747="" class="login-form__box">
						        <form data-v-3b623747="" class="login-form__input-form" action="<%=yesForm%>" method="post">
						            ...
						            <section data-v-3b623747="" class="login-form__input-area">
							            <input data-v-3b623747="" id="login-form__input-email" name="cId" type="text" placeholder="아이디(이메일 주소)를 입력하세요" required="required"> 
							            <input data-v-3b623747="" id="login-form__input-password" name="cPassword" type="password" placeholder="비밀번호를 입력하세요" required="required">
						            </section> 
						    ...
						    <article data-v-3b623747="" class="login__auth">
						        <section data-v-3b623747="">
						        	<a href="/member/adminLoginForm.jsp">
							            <p data-v-3b623747="" class="login__identify">관리자 로그인</p>
						        	</a>
						        </section>
						    </article>
