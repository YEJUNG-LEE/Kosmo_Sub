        	...
        	<div class="app__desktop-scroll">
            	<div>
	            	...
	            	<div data-v-78d799ef="">
					    ...
					    <p data-v-78d799ef="" class="register__title">마이페이지</p>
					    <section data-v-78d799ef="" class="register-status__box">
					        <div data-v-78d799ef="" class="register-status__centered">
					            ...
					            <p data-v-78d799ef="" class="register-status__text-2" style="color: rgb(0, 0, 0);">회원정보 확인</p>
					        </div>
					    </section>
					    <!---->
					    <section data-v-78d799ef="" class="register-input__container">
					        <p data-v-78d799ef="" class="register-input__desc">가입정보 출력</p>
					        
					        <form action="<%=yesForm%>" method="post">
                   				<input type="hidden" name="command" value="meDelete">
						        ...
						        <div data-v-78d799ef="" class="register-input__box">
						            <div data-v-78d799ef="" class="register-input__line">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="text" class="register-input__content-input" value="${sessionScope.loginfo.cId}" disabled="disabled">
						                	<input data-v-78d799ef="" type="hidden" name="cId" value="${sessionScope.loginfo.cId}">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="password" name="cPassword1"  class="register-input__content-input" disabled="disabled">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="password" name="cPassword2" class="register-input__content-input" disabled="disabled">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="text" name="cName" class="register-input__content-input" value="${sessionScope.loginfo.cName}" disabled="disabled">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<select data-v-78d799ef="" name="cGender">
						                		<c:if test="${sessionScope.loginfo.cGender == '남자'}">
							                        <option data-v-78d799ef="" value="남자" selected="selected">남자</option>
						                		</c:if>
						                		<c:if test="${sessionScope.loginfo.cGender == '여자'}">
							                        <option data-v-78d799ef="" value="여자" selected="selected">여자</option>
						                		</c:if>
						                    </select>
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="date" name="cBirth" class="register-input__content-input" value="${sessionScope.loginfo.cBirth}" disabled="disabled">
						                </div>
						            </div>
						        ...
						        <div data-v-78d799ef="" class="register-button__area">
							        ...
							        <button data-v-78d799ef="" type="submit" class="register-agree__submit">탈퇴하기
							        </button>
						        </div>
					        </form>
