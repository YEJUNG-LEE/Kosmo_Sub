	            	...
	            	<div data-v-78d799ef="">
					    ...
					    <section data-v-78d799ef="" class="register-status__box">
					        <div data-v-78d799ef="" class="register-status__centered">
					            ...
					            <p data-v-78d799ef="" class="register-status__text-2" style="color: rgb(0, 0, 0);">회원정보 수정</p>
					        </div>
					    </section>
					    <!---->
					        ...
					        <form action="<%=yesForm%>" method="post">
						        ...
						        <div data-v-78d799ef="" class="register-input__box">
						            ...
						            <div data-v-78d799ef="" class="register-input__line">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="password" id="password" name="cPassword1" class="register-input__content-input">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="password" id="password_confirm" name="cPassword2" class="register-input__content-input">						                	
						                </div>
						            ...
						            <div data-v-78d799ef="" class="register-input__line">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="text" name="cName" class="register-input__content-input" value="${sessionScope.loginfo.cName}">
						                </div>
						            </div>
						            <div data-v-78d799ef="" class="register-input__line">
						                <div data-v-78d799ef="" class="register-input__title">
						            ...
						            <div data-v-78d799ef="" class="register-input__line">
						                ...
						                <div data-v-78d799ef="" class="register-input__content">
						                	<input data-v-78d799ef="" type="date" name="cBirth" class="register-input__content-input" value="${sessionScope.loginfo.cBirth}">
						                </div>
						            </div>
						        ...
						        <div data-v-78d799ef="" class="register-button__area">
							        ...
							        <button data-v-78d799ef="" id="submit_button" class="register-agree__submit">수정하기
							        </button>
						        </div>
					        </form>
