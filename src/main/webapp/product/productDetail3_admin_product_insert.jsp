		                            ...
		                            <picture data-v-5a97542d="">
	                           		...
	                           		<div data-v-5a97542d="" class="detail-top__content">
	                           			<form action="<%=yesForm%>" method="post">
		                               		...
		                               		<h2 data-v-5a97542d="">
		                               			<input type="text" id="pName" name="pName" style="color: black; width: 380px;" placeholder="상품 이름(pName)">
		                               		</h2>
			                                ...
			                                <p data-v-5a97542d="" class="detail-top__content-price">
			                                	기준가 
			                                	<input type="text" id="pPrice" name="pPrice" style="color: black; width: 200px;" placeholder="상품 가격(pPrice)">
			                                	원 (600g)
			                                </p>
		                               		<div data-v-5a97542d="" class="detail-top__content-split">
		                               		</div>
		                               		<div data-v-5a97542d="" class="detail-top__content-count">
			                                    <p data-v-5a97542d="" class="detail-top__count-text">번호</p>
			                                    <div data-v-5a97542d="" class="detail-top__count-counter">
			                                        <div data-v-5a97542d="" class="detail-top__count-counter-centered">
				                                        
				                                        <input type="text" id="pNum" name="pNum" style="color: black; width: 319px; height: 50px; font-size: 24px;" placeholder="상품 번호(pNum)">
		                          			...
		                          			<div data-v-5a97542d="" class="detail-top__content-count">
			                                    ...
			                                    <div data-v-5a97542d="" class="detail-top__count-counter">
			                                        <div data-v-5a97542d="" class="detail-top__count-counter-centered">
				                                        ...
				                                        <input type="text" id="pStock" name="pStock" style="color: black; width: 319px; height: 50px; font-size: 24px;" placeholder="상품 재고(pStock)">
				                                        
			                                        </div>
			                                    </div>
		                               		</div>
		                               		<div data-v-5a97542d="" class="detail-top__content-btn">
		                               		<button data-v-5a97542d="" id="goto_mycart_button" class="detail-top__btn-button btn-button-gray">취소
		                               		</button> 
		                               			<input data-v-5a97542d="" class="detail-top__btn-button btn-button-red" type="submit" value="등록">
		                                	</div>
