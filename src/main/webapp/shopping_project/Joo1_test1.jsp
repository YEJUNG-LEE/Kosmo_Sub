        	...
        	<div class="app__desktop-scroll">
				...
				<div data-v-8d98596c="" class="payment__container">
					...
					<div data-v-8d98596c="">
						...
						<article data-v-8d98596c="" class="payment__status-box">
							<div data-v-8d98596c="" class="payment-status__centered">
								...
								<i data-v-8d98596c="" iconactive="true"
									...
									iconactive="false" class="payment-status__icon-step2"></i>
						...
						<div data-v-8d98596c="">
							<div data-v-8d98596c="" class="payment-address__container">
								<p data-v-8d98596c="" class="payment-address__title">보내시는 분</p>
								<div data-v-8d98596c="" class="payment-address__box">
									<div data-v-8d98596c="" class="payment-address__box-left">
										<div data-v-8d98596c="" class="payment-address__left-title">
											<p data-v-8d98596c="" class="payment-address__title-text">이름</p>
										</div>
										<div data-v-8d98596c="" class="payment-address__left-title">
											<p data-v-8d98596c="" class="payment-address__title-text">전화번호</p>
										</div>
										<div data-v-8d98596c="" class="payment-address__left-title">
											<p data-v-8d98596c="" class="payment-address__title-text">이메일</p>
										</div>
									</div>
									<div data-v-8d98596c="" class="payment-address__box-right">
										<div data-v-8d98596c="" class="payment-address__right-content">
											<p data-v-8d98596c="" class="payment-address__content-text">주병훈</p>
										</div>
										<div data-v-8d98596c="" class="payment-address__right-content">
											<p data-v-8d98596c="" class="payment-address__content-text">01076550964</p>
										</div>
										<div data-v-8d98596c="" class="payment-address__right-content">
											<p data-v-8d98596c="" class="payment-address__content-text">wnqudgns94@naver.com</p>
										</div>
									</div>
								</div>
								<p data-v-8d98596c="" class="payment-address__title"
									style="float: left;">받으시는 분</p>
								<button data-v-8d98596c="" class="payment-address__button" onclick="myFunction()">주소선택</button>
								...
								<div data-v-8d98596c="" class="payment-address__box">
									<div data-v-8d98596c="" class="payment-address__box-left">
										...
										<div data-v-8d98596c="" class="payment-address__left-title"
											style="height: 74px;">
											<p data-v-8d98596c="" class="payment-address__title-text">주소</p>
										</div>
									</div>
									<div data-v-8d98596c="" class="payment-address__box-right">
										<div data-v-8d98596c="" class="payment-address__right-content">
											<p data-v-8d98596c="" class="payment-address__content-text"></p>
										</div>
										<div data-v-8d98596c="" class="payment-address__right-content">
											<p data-v-8d98596c="" class="payment-address__content-text"></p>
										</div>
										<div data-v-8d98596c="" class="payment-address__right-content"
											style="height: 74px;">
											<p data-v-8d98596c="" class="payment-address__content-text">
												주소<br data-v-8d98596c="">동호수
											</p>
										</div>
									</div>
								</div>
							...
							<div data-v-8d98596c="" class="payment-step__area">
								<button data-v-8d98596c="" class="payment__btn background__gray">이전
									단계</button>
								<a href="http://localhost:8990/WebStudent/shopping.project/Joo2.jsp">
